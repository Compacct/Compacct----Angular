...
export class TutoPendsubscriptionComponent implements OnInit {
  ...
  Billcreation(col) {
    ...
    const Link = '/Tutopia_Student_Order/Index?Subscription_Txn_ID='+ window.btoa(col.Subscription_Txn_ID) +'&Menu_Reff_ID='+ this.$CompacctAPI.CompacctCookies.Menu_Ref_ID;
     window.open(Link);
  }
// EXPORT TO EXCEL
