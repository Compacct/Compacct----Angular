...
export class TutoClassManagementComponent implements OnInit {
  ...
  UpdateDATA (obj,type){
    ...
    if(valid) {
      ...
      const Tempobj = {
        "Report_Name": type ==='class' ? "Update_Class_Name" : "Update_Subject_Name",
        "Json_Param_String" : JSON.stringify([valid])
      }
      this.GlobalAPI
  ...
  RefreshAll(){
    this.SubjectClassID = undefined;
    this.SubjectFormSubmit = false;
    this.ChapterClassID = undefined;
    this.ChapterSubjectID = undefined;
    this.ChapterFormSubmit = false;
    this.TutorialClassID = undefined;
    this.TutorialSubjectID = undefined;
    this.TutorialChapterID = undefined;
    this.TutorialFormSubmit = false;
    this.ClassList1 = [];
