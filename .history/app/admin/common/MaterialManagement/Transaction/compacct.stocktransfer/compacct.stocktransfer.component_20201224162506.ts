    ...
    this.$CompacctAPI
      ...
      .subscribe((data: any) => {
        ...
        this.NativeProductList.forEach(el => {
          ...
          if(el.IGST_Rate || el.SGST_Rate || el.CGST_Rate) {
            console.log(el)
          }
        });
      });
  ...
  ProductChange(productID) {
    ...
    if (productID) {
      if (this.ObjCostCenterFROM.F_Cost_Cen_ID) {
        ...
        this.ObjProductInfo.IGST_Input_Ledger_ID = obj.CGST_Output_Ledger_ID;
        ...
        if (
          ...
          if (
            ...
            for (let i = 0; i < this.SelectedSerialNo.length; i++) {
              ...
              this.ObjProductInfo.IGST_Input_Ledger_ID =
