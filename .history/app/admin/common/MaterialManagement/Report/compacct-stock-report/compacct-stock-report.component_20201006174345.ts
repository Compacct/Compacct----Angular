...
export class CompacctStockReportComponent implements OnInit {
  ...
  GetTotal(Arr){
    ...
    for(let i = 0; i < Arr.length; i++) {
      if(Arr[i].Product) {
        count += Number(Arr[i].AKS ? Arr[i].AKS : 0);
        count += Number(Arr[i].BFP ? Arr[i].BFP : 0);
        count += Number(Arr[i].BKH ? Arr[i].BKH : 0);
        count += Number(Arr[i].BRT ? Arr[i].BRT : 0);
        count += Number(Arr[i].BUTWAL ? Arr[i].AKS : 0);
        count += Number(Arr[i].CHN ? Arr[i].AKS : 0);
        count += Number(Arr[i].KCL ? Arr[i].AKS : 0);
        count += Number(Arr[i].KRISHNA ? Arr[i].AKS : 0);
        count += Number(Arr[i].KTM ? Arr[i].AKS : 0);
        count += Number(Arr[i].NIRMAL ? Arr[i].AKS : 0);
        count += Number(Arr[i].TA00001 ? Arr[i].AKS : 0);
        count += Number(Arr[i].TAPP ? Arr[i].AKS : 0);
        count += Number(Arr[i].VKS ? Arr[i].AKS : 0);
