...
export class CompacctStockReportComponent implements OnInit {
  ...
  GetTotal(obj){
    let count = 0;
    if(obj.Product) {
      count += Number(obj.AKS ? obj.AKS : 0);
      count += Number(obj.BFP ? obj.BFP : 0);
      count += Number(obj.BKH ? obj.BKH : 0);
      count += Number(obj.BRT ? obj.BRT : 0);
      count += Number(obj.BUTWAL ? obj.AKS : 0);
      count += Number(obj.CHN ? obj.AKS : 0);
      count += Number(obj.KCL ? obj.AKS : 0);
      count += Number(obj.KRISHNA ? obj.AKS : 0);
      count += Number(obj.KTM ? obj.AKS : 0);
      count += Number(obj.NIRMAL ? obj.AKS : 0);
      count += Number(obj.TA00001 ? obj.AKS : 0);
      count += Number(obj.TAPP ? obj.AKS : 0);
      count += Number(obj.VKS ? obj.AKS : 0);
