...
onFileChange(ev) {
  ...
  reader.onload = (event) => {
    ...
    const columCheck =
     this.BOQdataString[0][firstkey] === "SL NO." && this.BOQdataString[0].__EMPTY === "DESCRIPTION OF WORK"  &&
     ...
     this.BOQdataString[0].__EMPTY_5 === "AMOUNT IN RS." ? true:false;
     if(columCheck){
        ...
        this.PDFFlag = false;
        this.compacctToast.clear();
        const errorMgs = `<table><thead><tr><td>Choosed File Format</td><td>System Format</td><td>Match Flag</td><tr></thead><tr><tbody><tr><td>` + this.BOQdataString[0][firstkey] +`</td>
        <td>SL NO.</td>
        <td>`+this.compare(this.BOQdataString[0][firstkey],"SL NO.")+ `</td> <tr>
        <td>`+ this.BOQdataString[0].__EMPTY +`</td>
        <td>DESCRIPTION OF WORK</td>
        <td>` +this.compare(this.BOQdataString[0].__EMPTY,"DESCRIPTION OF WORK")+`</td></tr><tr>
        <td>` + this.BOQdataString[0].__EMPTY_1 +`</td>
        <td>ITEM CODE</td>
        <td>` +this.compare(this.BOQdataString[0].__EMPTY_1,"ITEM CODE")+`</td></tr><tr>
        <td>`+ this.BOQdataString[0].__EMPTY_2 +`</td>
        <td>QNTY./NOS.</td>
        <td>` +this.compare(this.BOQdataString[0].__EMPTY_2,"QNTY./NOS.")+`</td></tr><tr>
        <td>`+ this.BOQdataString[0].__EMPTY_3 +`</td>
        <td>UNIT</td>
        <td>` +this.compare(this.BOQdataString[0].__EMPTY_3,"UNIT")+`</td></tr><tr>
        <td>`+ this.BOQdataString[0].__EMPTY_4 +`</td>
        <td>ESTIMATED RATE</td>
        <td>` +this.compare(this.BOQdataString[0].__EMPTY_4,"ESTIMATED RATE")+`</td></tr><tr>
        <td>`+ this.BOQdataString[0].__EMPTY_5 +`</td>
        <td>AMOUNT IN RS.</td>
        <td>` +this.compare(this.BOQdataString[0].__EMPTY_5,"AMOUNT IN RS.")+`</td></tr><tr></tbody></table>`
