...
getTotalExcelData() {
  ...
  if(this.BidOpenListViewByLottery.length) {
    ...
    percentage1 = objTemp.Quoted_Percentage;
  ...
  if(e) {
   ...
   this.BOQExcelLessTotal = PercentageVal;
   this.BOQExcelGrandTotal = Rate;
  ...
  reader.onload = (event) => {
    ...
    const columCheck =
     ...
     if(columCheck){
        ...
        <td class='text-center'>` +this.compare(this.BOQdataString[0].__EMPTY,"DESCRIPTION OF WORK")+`</td></tr><tr>
        ...
        <td>AMOUNT IN RS.</td>
        <td class='text-center'>` +this.compare(this.BOQdataString[0].__EMPTY_5,"AMOUNT IN RS.")+`</td></tr><tr></tbody></table>`
