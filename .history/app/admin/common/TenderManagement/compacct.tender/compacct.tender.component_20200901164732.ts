...
onFileChange(ev) {
  ...
  reader.onload = (event) => {
    ...
    const columCheck =
     this.BOQdataString[0][firstkey] === "SL NO." && this.BOQdataString[0].__EMPTY === "DESCRIPTION OF ITEM"  &&
     ...
     if(columCheck){
        ...
        <td class='text-center'>` +this.compare(this.BOQdataString[0].__EMPTY,"DESCRIPTION OF ITEM")+`</td></tr><tr>
