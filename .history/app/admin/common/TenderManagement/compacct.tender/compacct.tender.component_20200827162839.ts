...
onFileChange(ev) {
  ...
  reader.onload = (event) => {
    ...
    console.log(this.BOQdataString[0]);
    console.log(this.BOQdataString[0][firstkey].toUpperCase() === "SL N0.");
    console.log(this.BOQdataString[0].__EMPTY.toUpperCase() === "DESCRIPTION OF WORK");
    console.log(this.BOQdataString[0].__EMPTY_1.toUpperCase() === "ITEM CODE");
    console.log(this.BOQdataString[0].__EMPTY_2.toUpperCase()=== "QNTY./NOS.");
    console.log(this.BOQdataString[0].__EMPTY_3.toUpperCase() === "UNIT");
    console.log(this.BOQdataString[0].__EMPTY_4.toUpperCase() === "ESTIMATED RATE");
    console.log(this.BOQdataString[0].__EMPTY_5.toUpperCase() === "AMOUNT IN RS.");
    const columCheck =
     this.BOQdataString[0][firstkey].toUpperCase() === "SL N0." && this.BOQdataString[0].__EMPTY.toUpperCase() === "DESCRIPTION OF WORK"  &&
     this.BOQdataString[0].__EMPTY_1.toUpperCase() === "ITEM CODE" && this.BOQdataString[0].__EMPTY_2.toUpperCase() === "QNTY./NOS." &&
     this.BOQdataString[0].__EMPTY_3.toUpperCase() === "UNIT" && this.BOQdataString[0].__EMPTY_4.toUpperCase() === "ESTIMATED RATE" &&
     this.BOQdataString[0].__EMPTY_5.toUpperCase() === "AMOUNT IN RS." ? true:false;
     if(columCheck){
