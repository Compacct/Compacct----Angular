  ...
  reader.onload = (event) => {
    ...
    const columCheck =
     ...
     if(columCheck){
        ...
        this.PDFFlag = false;
        this.compacctToast.clear();
        const errorMgs = `<div>` + this.BOQdataString[0][firstkey] +`= "SL NO."`+this.compare(this.BOQdataString[0][firstkey],"SL NO.")+` </div>
...
compare(a,b) {
  const returnCode = a === b ? '<i class="fa fa-fw fa-check-square" style="color:#34A835" aria-hidden="true"></i>' : '<i class="fa fa-fw fa-window-close"  style="color:#f03a17" aria-hidden="true"></i>';
  return returnCode;
}
