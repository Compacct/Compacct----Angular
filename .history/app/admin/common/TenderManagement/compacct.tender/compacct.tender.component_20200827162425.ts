...
onFileChange(ev) {
  ...
  reader.onload = (event) => {
    ...
    console.log(this.BOQdataString[0][firstkey].toUpperCase());
    console.log(this.BOQdataString[0].__EMPTY.toUpperCase());
    console.log(this.BOQdataString[0].__EMPTY_1.toUpperCase());
    console.log(this.BOQdataString[0].__EMPTY_2.toUpperCase());
    console.log(this.BOQdataString[0].__EMPTY_3.toUpperCase());
    console.log(this.BOQdataString[0].__EMPTY_4.toUpperCase());
    console.log(this.BOQdataString[0].__EMPTY_5.toUpperCase());
    const columCheck =
