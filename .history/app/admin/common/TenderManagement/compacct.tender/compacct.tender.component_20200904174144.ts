...
// Save
  ...
  CheckIfTenderIDExist(){
    if(this.ObjTender.Tender_ID) {
      ...
      this.$http
        .get("/BL_CRM_Txn_Enq_Tender/Check_Tender_ID_Exist?Tender_ID="+this.ObjTender.Tender_ID , {headers: headers})
        .subscribe((data: any) => {
          console.log(data);
        });
    }
  ...
  CheckIfTenderNameExist(){
    ...
    this.$http
      .get("/BL_CRM_Txn_Enq_Tender/Check_Tender_Name_Exist", { params })
      .subscribe((data: any) => {
        console.log(data);
      });
    }
