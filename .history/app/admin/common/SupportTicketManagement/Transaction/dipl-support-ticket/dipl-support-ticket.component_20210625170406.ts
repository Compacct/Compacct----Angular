    ...
    if (valid) {
      ...
      const end = this.ObjSearch.end_dt_time
        ...
        const obj = {
          ...
          "Json_Param_String": JSON.stringify([{'Start_Date': start,'End_Date':end , 'Status_ID' : this.ObjSearch.Status_ID,'Created_By': this.ObjSearch.Asigned_To ? this.ObjSearch.Asigned_To : 0}])
        }
        this.GlobalAPI
            .CommonTaskData2(obj)
            .subscribe((data: any) => {
