  ...
  AddDetailList(valid) {
    ...
    if(valid && validFlag) {
      ...
      if(this.ObjJobData.Type_of_Work === 'Bridges and Culverts' && ItemFlag === 'HP') {
        ...
        for(let i = 0; i < this.DetailList2.length; i++) {
          const struc = this.DetailList2[i].structure_at_km +'/'+this.DetailList[i].structure_at_meter;
        ...
        for(let i = 0; i < this.DetailList3.length; i++) {
          const struc = this.DetailList3[i].structure_at_km +'/'+this.DetailList[i].structure_at_meter;
          if (processed3.indexOf(struc)<0) {
            processed3.push(struc);
