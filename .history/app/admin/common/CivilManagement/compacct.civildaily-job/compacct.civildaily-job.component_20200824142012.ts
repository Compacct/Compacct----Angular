  ...
  AddDetailList(valid) {
    ...
    if(valid && validFlag) {
      ...
      if(this.ObjJobData.Type_of_Work === 'Bridges and Culverts' && ItemFlag === 'HP') {
        ...
        for(let i = 0; i < this.DetailList2.length; i++) {
          if (processed3.indexOf(this.DetailList2[i].structure_at)<0) {
            processed3.push(this.DetailList2[i].structure_at);
            this.DistinctStructure2.push({
              structure:this.DetailList2[i].structure_at,
        ...
        for(let i = 0; i < this.DetailList3.length; i++) {
          if (processed3.indexOf(this.DetailList3[i].structure_at)<0) {
            processed3.push(this.DetailList3[i].structure_at);
            this.DistinctStructure3.push({
              structure:this.DetailList3[i].structure_at,
      ...
      this.DistinctItemCode3.sort((a, b) => (Number(a.Sl_No) > Number(b.Sl_No)) ? 1 : -1);
        ...
        if(this.ObjJobData.Type_of_Work === 'Bridges and Culverts'){
          ...
          for(let i = 0; i < this.DetailList.length; i++) {
            if (processed.indexOf(this.DetailList[i].structure_at)<0) {
              processed.push(this.DetailList[i].structure_at);
              this.DistinctStructure.push({
                structure:this.DetailList[i].structure_at,
