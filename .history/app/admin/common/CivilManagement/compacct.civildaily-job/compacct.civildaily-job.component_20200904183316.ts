...
return flag;
  ...
  ChangeStructureDetails(StructureID){
    ...
    if(StructureID) {
      ...
      if(this.ObjJobData.Type_of_Work ==='Road Works (Concrete)') {
        const obj = $.grep(this.StructureTypeDetailList2,function(obj){ return obj.Concrete_Structure_ID === StructureID})[0];
  ...
  check3DigitChanage(val:any , fieldName) {
    if(val.length) {
      ...
      if(this.ObjJobData[fieldName].length <= 3) {
  ...
  AddDetailList(valid) {
    ...
    this.ObjJobData.Trip_Arr = [];
    const validFlag = this.ObjJobData.Type_of_Work === 'Bridges and Culverts Works' || this.ObjJobData.Type_of_Work === 'Road Works (Concrete)' ? true : this.GridValidationCheck();
    if(valid && validFlag) {
...
if(valid) {
  ...
  CreateStructureType2(valid){
    ...
    if(valid) {
        ...
        const obj = {
          Party : this.ObjJobData.Party,
          Chainage_From_km :this.ObjJobData.Chanage_From_KM,
          Chainage_From_meter : this.ObjJobData.Chanage_From_M,
          Chainage_From  : this.ObjJobData.Chanage_From_KM +'.'+ this.ObjJobData.Chanage_From_M,
          Chainage_To_km : this.ObjJobData.Chanage_To_KM,
          Chainage_To_meter:this.ObjJobData.Chanage_To_M,
          Chainage_To :this.ObjJobData.Chanage_To_KM +'.'+ this.ObjJobData.Chanage_To_M,
