...
return flag;
  ...
  ChangeStructureDetails(StructureID){
    ...
    if(StructureID) {
      ...
      if((this.ObjJobData.UNIT === 'No.' || this.ObjJobData.UNIT === 'Nos.') && this.ObjJobData.Type_of_Work ==='Bridges and Culverts' ){
  ...
  this.ObjJobData.bridge_item = undefined;
    ...
    if(obj) {
      ...
      if(this.ObjJobData.Type_of_Work) {
        ...
        this.ObjJobData.Side=this.ObjJobData.Type_of_Work ==='Bridges and Culverts' ? 'Both Side': undefined;
      }
  ...
  AddDetailList(valid) {
    ...
    this.ObjJobData.Trip_Arr = [];
    const validFlag = this.ObjJobData.Type_of_Work === 'Bridges and Culverts' ? true : this.GridValidationCheck();
    if(valid && validFlag) {
