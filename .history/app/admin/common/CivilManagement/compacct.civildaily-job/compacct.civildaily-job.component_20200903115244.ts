...
return flag;
  ...
  ChangeStructureDetails(StructureID){
    ...
    if(StructureID) {
      if(this.ObjJobData.Structure_Details ==='Bridges and Culverts Works') {
        ...
        if((this.ObjJobData.UNIT === 'No.' || this.ObjJobData.UNIT === 'Nos.') && this.ObjJobData.Type_of_Work ==='Bridges and Culverts Works' ){
      ...
      if(this.ObjJobData.Structure_Details ==='Road works (Concrete)') {
...
if(valid) {
  ...
  CreateStructureType2(valid){
    ...
    if(valid) {
        ...
        const obj = {
          Party : this.ObjJobData.Party,
          Chanage_From_KM:this.ObjJobData.Chanage_From_KM,
          Chanage_From_M: this.ObjJobData.Chanage_From_M,
          Chanage_To_KM: this.ObjJobData.Chanage_To_KM,
          Chanage_To_M:this.ObjJobData.Chanage_To_M,
