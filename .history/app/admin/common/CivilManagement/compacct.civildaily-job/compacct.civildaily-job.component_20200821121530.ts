...
return flag;
  ...
  FetchCoefficient() {
    this.ObjJobData.Co_efficient = undefined;
    if (this.ObjJobData.Dia) {
      this.ObjJobData.Co_efficient = $.grep(this.DiaList,function(obj){ return obj.dia === this.ObjJobData.Dia})[0].co_eff;
      this.CalculateCoefficientQty();
    }
  }
  ...
  if(valid) {
      ...
      `&structure_at_meter=`+this.ObjJobData.structure_at_meter+`&Structured_Type=`+this.ObjJobData.Structured_Type+`&Structured_Breadth=`+this.ObjJobData.Structured_Breadth+
