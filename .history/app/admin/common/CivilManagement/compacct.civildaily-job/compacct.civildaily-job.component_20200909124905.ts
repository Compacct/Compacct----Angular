    ...
    if(this.StructureTypeDetailList2.length){
      ...
      for(let i = 0; i < this.StructureTypeDetailList2.length; i++) {
        if(this.StructureTypeDetailList2[i].Structure_Side === this.ObjJobData.Structure_Side){
          const checkFrom = this.isBetween(Number(Chanage_From),Number(this.StructureTypeDetailList2[i].Chanage_From),Number(this.StructureTypeDetailList2[i].Chanage_To),'Tovalid');
          const checkTo = this.isBetween(Number(Chanage_To),Number(this.StructureTypeDetailList2[i].Chanage_To),Number(this.StructureTypeDetailList2[i].Chanage_From),'Fromvalid');
          if(checkFrom || checkTo) {
            console.log('found between');
