  ...
  editData(){
    ...
    const TempEditObj={
      ...
      this.GlobalAPI.getData(Editobj).subscribe((data: any) => {
        ...
        this.ObjImp.Right_Type= data[0].Right_Type ? data[0].Right_Type : undefined;
        this.ObjImp.Left_Type= data[0].Left_Type ? data[0].Left_Type : undefined;
        ...
        this.ObjImp.Eustachian_Test= data[0].Eustachian_Test ? data[0].Eustachian_Test : undefined;
        this.ObjImp.Eustachian_Result_Left= data[0].Eustachian_Result_Left ? data[0].Eustachian_Result_Left : undefined;
        this.ObjImp.Eustachian_Result_Right= data[0].Eustachian_Result_Right ? data[0].Eustachian_Result_Right : undefined;
        this.ObjImp.Reflax_Right_Ipsi_500=  data[0].Reflax_Right_Ipsi_500 ? data[0].Reflax_Right_Ipsi_500 : undefined;
        this.ObjImp.Reflax_Right_Ipsi_1000= data[0].Reflax_Right_Ipsi_1000 ? data[0].Reflax_Right_Ipsi_1000 : undefined;
        this.ObjImp.Reflax_Right_Ipsi_2000= data[0].Reflax_Right_Ipsi_2000 ? data[0].Reflax_Right_Ipsi_2000 : undefined;
        this.ObjImp.Reflax_Right_Ipsi_4000= data[0].Reflax_Right_Ipsi_4000 ? data[0].Reflax_Right_Ipsi_4000 : undefined;
        this.ObjImp.Reflax_Right_Contra_500= data[0].Reflax_Right_Contra_500 ? data[0].Reflax_Right_Contra_500 : undefined;
        this.ObjImp.Reflax_Right_Contra_1000= data[0].Reflax_Right_Contra_1000 ? data[0].Reflax_Right_Contra_1000 : undefined;
        this.ObjImp.Reflax_Right_Contra_2000= data[0].Reflax_Right_Contra_2000 ? data[0].Reflax_Right_Contra_2000 : undefined;
        this.ObjImp.Reflax_Right_Contra_4000= data[0].Reflax_Right_Contra_4000 ? data[0].Reflax_Right_Contra_4000 : undefined;
        this.ObjImp.Reflax_Left_Ipsi_500= data[0].Reflax_Left_Ipsi_500 ? data[0].Reflax_Left_Ipsi_500 : undefined;
        this.ObjImp.Reflax_Left_Ipsi_1000= data[0].Reflax_Left_Ipsi_1000 ? data[0].Reflax_Left_Ipsi_1000 : undefined;
        this.ObjImp.Reflax_Left_Ipsi_2000= data[0].Reflax_Left_Ipsi_2000 ? data[0].Reflax_Left_Ipsi_2000 : undefined;
        this.ObjImp.Reflax_Left_Ipsi_4000= data[0].Reflax_Left_Ipsi_4000 ? data[0].Reflax_Left_Ipsi_4000 : undefined;
        this.ObjImp.Reflax_Left_Contra_500= data[0].Reflax_Left_Contra_500 ? data[0].Reflax_Left_Contra_500 : undefined;
        this.ObjImp.Reflax_Left_Contra_1000= data[0].Reflax_Left_Contra_1000 ? data[0].Reflax_Left_Contra_1000 : undefined;
        this.ObjImp.Reflax_Left_Contra_2000= data[0].Reflax_Left_Contra_2000 ? data[0].Reflax_Left_Contra_2000 : undefined;
        this.ObjImp.Reflax_Left_Contra_4000= data[0].asReflax_Left_Contra_4000 ? data[0].asReflax_Left_Contra_4000 : undefined;
        this.ObjImp.Comment= data[0].Comment;
        this.ObjImp.Left_Ear_Interpretation= data[0].Left_Ear_Interpretation ? data[0].Left_Ear_Interpretation : undefined;
        this.ObjImp.Right_Ear_Interpretation= data[0].Right_Ear_Interpretation ? data[0].Right_Ear_Interpretation : undefined;
