...
@Component({
  ...
  templateUrl: './store-item-indent.component.html',
  styleUrls: ['./store-item-indent.component.css'],
  providers: [MessageService],
  encapsulation: ViewEncapsulation.None
})
export class StoreItemIndentComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.Header.pushHeader({
      Header: "Store Item Indent",
      Link: " Outlet -> Store Item Indent"
    });
 this.onload();
 this.GetOutletName();
  }
  async onload() {
   ...
   async getProductSubTypeList(){
     const obj = {
       ...
       "Report_Name_String": "Get Sale Requisition Time Out For Store Item",
 ...
 GetDate(){
   ...
   this.GlobalAPI.getData(obj).subscribe((data:any)=>{
     ...
     this.cutOffDate = new Date(data[0].Requision_Time_Store);
 ...
 if(this.ObjRequistion.Cost_Cen_ID){
  //console.log(this.ObjRequistion.Cost_Cen_ID);
   ...
   const obj = {
     ...
     "Report_Name_String": "GET_Store_Item_Products",
