...
@Component({
  ...
  templateUrl: './stock-transfer-to-store.component.html',
  styleUrls: ['./stock-transfer-to-store.component.css'],
...
export class StockTransferToStoreComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.Header.pushHeader({
      Header: this.MaterialType_Flag + " Stock Transfer To Store ",
      Link: " Material Management -> " + this.MaterialType_Flag + " Stock Transfer To Store "
  ...
  GetToCostCen(){
    ...
    this.GlobalAPI.getData(obj).subscribe((data:any)=>{
     ...
     // if(this.$CompacctAPI.CompacctCookies.User_Type != 'A'){
      ...
      // this.GetToGodown();
      // } else {
        this.ObjRawMateriali.To_Cost_Cen_ID = 49;
        this.TCdisableflag = true;
        this.GetToGodown();
     // }
  ...
  GetBToCostCen(){
    ...
    this.GlobalAPI.getData(obj).subscribe((data:any)=>{
     ...
     // if(this.$CompacctAPI.CompacctCookies.User_Type != 'A'){
      ...
      // this.GetBToGodown();
      // } else {
        this.ObjBrowse.To_Cost_Cen_ID = 49;
        this.TBCdisableflag = true;
        this.GetBToGodown();
       // this.ToBGodownList = [];
      //}
  ...
  GetProductList(valid){
    this.StockTransfertoStoreFormSubmitted = true;
    if(valid){
  ...
  this.GlobalAPI.getData(obj).subscribe((data:any)=>{
   ...
   this.BackupIndentList = tempData;
    this.StockTransfertoStoreFormSubmitted = false;
    this.GetProductType();
