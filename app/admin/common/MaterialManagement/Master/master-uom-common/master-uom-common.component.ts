...
@Component({
  selector: 'app-master-uom-common',
  templateUrl: './master-uom-common.component.html',
  styleUrls: ['./master-uom-common.component.css'],
  providers: [MessageService],
  encapsulation: ViewEncapsulation.None
})
export class MasterUOMCommonComponent implements OnInit {
  tabIndexToView = 0;
  items = [];
  menuList = [];
  AllCostcenterList = [];
      ...
      if(this.ObjUom.UOM_Id){
        ...
        const obj = {
         ...
         this.compacctToast.add({
          key: "compacct-toast",
          severity: "error",
          summary: "UOM Validation ",
          detail: "UOM Already Exits."
        });
      this.clearData();
    }
