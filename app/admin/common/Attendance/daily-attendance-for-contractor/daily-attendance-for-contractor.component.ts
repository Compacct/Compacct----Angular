...
@Component({
  selector: 'app-daily-attendance-for-contractor',
  templateUrl: './daily-attendance-for-contractor.component.html',
  styleUrls: ['./daily-attendance-for-contractor.component.css'],
  providers: [MessageService],
  encapsulation: ViewEncapsulation.None
})
export class DailyAttendanceForContractorComponent implements OnInit {
  items:any = [];
  Spinner = false;
  seachSpinner = false
  ShowSpinner = false;
  ...
  ngOnInit() {
    this.Header.pushHeader({
      Header: "Daily Attendance For contractor",
      Link: " HR -> Transaction -> Daily Attendance For contractor"
    });
  ...
  getAttendanceType(){
    const obj = {
      "SP_String": "SP_HR_Attn_Sheet_Day_Wise_For_Contractor",
  ...
  SaveDailyAttendance(){
      ...
      const obj = {
        "SP_String": "SP_HR_Attn_Sheet_Day_Wise_For_Contractor",
        "Report_Name_String" : "Insert_HR_Attn_Sheet_Day_Wise_Contractor",
