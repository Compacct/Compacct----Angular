...
@Component({
  selector: 'app-purchase-bill-gst-one-sp',
  templateUrl: './purchase-bill-gst-one-sp.component.html',
  styleUrls: ['./purchase-bill-gst-one-sp.component.css'],
  providers: [MessageService],
  encapsulation: ViewEncapsulation.None
})
export class PurchaseBillGSTOneSPComponent implements OnInit {
  items:any = [];
  menuList:any = [];
  Spinner = false;
  seachSpinner = false
